    ...
    return Column(
      children: [
        ...
        Column(
          ...
          children: [
            Text("${Arrays.cat[index]["imgtxt"]}", style: TextStyle(fontSize: 28 ,),),
            SizedBox(height: 20,),
            Text("${Arrays.cat[index]["imgtxt"]}", style: TextStyle(fontSize: 15 , color: Colors.grey),),
            Text("Price Start from :", style: TextStyle(fontSize: 15 , color: Colors.grey),),
            Text("${Arrays.cat[index]["price"]}", style: TextStyle(fontSize: 15 , color: Colors.grey),),
    ...
    return Row(
      children: [
        ...
        CircleAvatar(
          ...
          backgroundImage: NetworkImage("${Arrays.hcat[index]["cimg"]}"),
        ),
        SizedBox(width: 7,),
        Text("${Arrays.hcat[index]["htxt"]}" , style: TextStyle(fontWeight: FontWeight.bold , fontSize: 13),),],
    );
  }
}
